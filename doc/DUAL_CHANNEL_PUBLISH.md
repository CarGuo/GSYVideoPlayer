...
这样配置后：
- `./gradlew publish` → `com.shuyu:gsyvideoplayer-base:13.1.0` (GitHub)
- `./gradlew publishMavenCentralPublicationToSonatypeRepository` → `io.github.carguo:gsyvideoplayer-base:13.1.0` (Maven Central)
