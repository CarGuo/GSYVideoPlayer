...
| 渠道 | GROUP ID | 依赖示例 |
|-----|----------|---------|
| **GitHub Packages** | `com.shuyu` | `implementation 'com.shuyu:gsyvideoplayer-java:13.2.0'` |
| **Maven Central** | `io.github.carguo` | `implementation 'io.github.carguo:gsyvideoplayer-java:13.2.0'` |
